...
const CoffeeWritePage = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await saveCoffeeLog(requestData);
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <div className="color-picker-container">
              ...
              {moodColors.length < 3 && (
                <div className="add-color-btn" onClick={() => setShowColorPicker(true)}>
                  +
                </div>
              )}
          ...
          <div className="form-group">
            ...
            <div className="tags-input-container">
              ...
              <input 
                type="text" 
                className="tag-input"
                placeholder="태그 입력 후 엔터 (예: 자스민, 초콜릿)"
                value={tagInput}
...
export default CoffeeWritePage;